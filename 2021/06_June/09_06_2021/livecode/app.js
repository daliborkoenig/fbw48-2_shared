...
// let todayDate = new Date().getTime() // today in ms
// let birthday = new Date("1981-02-16").getTime() // bday in ms

let todayDate = new Date()
let birthday = new Date("1981-02-16")

let difference = todayDate - birthday // ms to date

let diffDate = new Date(difference)
console.log(diffDate.getFullYear() - 1970);  // years old
let age = todayDate.getFullYear() - birthday.getFullYear();
let m = todayDate.getMonth() - birthday.getMonth()
age = age * 12 + m
console.log(age);
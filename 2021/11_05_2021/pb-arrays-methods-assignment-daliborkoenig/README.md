 ## Assigment
 you have this object database.
 
 1- create a function to search inside the meals according strMeal : example 
 ```js 
// searchMeal('salmon') => 4 meals are available with this ids : 52959,52773,52960,25823
 ```
 2- create a function to edit a meal according the idMeal 
  ```js 
// editMeal(52959,{ strMeal : "Smoked Fish " ,strMealThumb:"https:\/\/www.themealdb.com\/images\/media\/meals\/1548772327.jpg"  })  
 ```
 3- create a function to delete a meal according the idMeal
  ```js 
// deleteMeal(52959)  
 ```
 ```js
